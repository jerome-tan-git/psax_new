...
<!-- Header Start -->
		...
		<div class="flexslider">
		    <ul class="slides">
		        ...
		        <li>
		            <div class="slider_content">
		                <div class="thumb_img" style="background: url('./images/home_2.png') no-repeat;">&nbsp;</div>
		                <div class="description">
		                    <h2 class="home_left">热忱帮助暖人心</h2>
		                    <h2>精心指导收益深</h2>
		            	</div>
		            </div>
		        </li>
		        <li>
		            <div class="slider_content">
		                <div class="thumb_img" style="background: url('./images/home_3.png') no-repeat;">&nbsp;</div>
		                <div class="description">
		                    <h2 class="home_left">服务企业</h2>
		                    <h2>尽心尽责</h2>
		            	</div>
		            </div>
		        </li>
		        <li>
		            <div class="slider_content">
		                <div class="thumb_img" style="background: url('./images/home_4.png') no-repeat;">&nbsp;</div>
		                <div class="description">
		                    <h2 >热忱服务</h2>
		        ...
		        <li>
		            <div class="slider_content">
		                <div class="thumb_img" style="background: url('./images/home_5.png') no-repeat;">&nbsp;</div>
		                <div class="description">
		                    <h2 class="home_left">精心指导</h2>
		                    <h2>无私奉献</h2>
		            	</div>
		        ...
		        <li>
		            <div class="slider_content">
		                <div class="thumb_img" style="background: url('./images/home_6.png') no-repeat;">&nbsp;</div>
		                <div class="description">
		                    <h2 >服务企业</h2>
